  ...
  <div class="fik-db-side-menu">
    <div id="accordion">
      ...
      <div class="card">
        <a href="<?= base_url('adminlaa') ?>" class="btn"><span class="fas fa-align-left"></span> Pendaftaran TA</a>
      </div>
      <div class="card">
        <a href="<?= base_url('adminlaa/daftarsidang') ?>" class="btn"><span class="fas fa-chalkboard-teacher"></span> Pendaftaran Sidang</a>
      </div>
      <div class="card">
        <a href="<?= base_url('listmhs') ?>" class="btn"><span class="fas fa-users"></span> List Mahasiswa</a>
      </div>
      <div class="card">
        <a href="#" class="btn" data-toggle="collapse" data-target="#collapse2" aria-expanded="true" aria-controls="collapse2"><span class="fas fa-tasks"></span> Progress Bimbingan</a>
        <div id="collapse2" class="collapse" data-parent="#accordion">
          <ul>
            <li><a href="<?= base_url('adminlaa/preview1') ?>">Preview 1</a></li>
            <li><a href="<?= base_url('adminlaa/preview2') ?>">Preview 2</a></li>
            <li><a href="<?= base_url('adminlaa/preview3') ?>">Preview 3</a></li>
          </ul>
        </div>
      </div>
