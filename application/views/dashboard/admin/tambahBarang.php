            ...
            <div class="card-body">
              <div class="custom-form">
                <div class="form-group">
                  <input type="text" name="" value="" class="form-control" placeholder="" required="required" autocomplete="off" />
                  <label>Nama Barang</label>
                </div>
                <div class="form-group">
                  <input type="number" name="" value="" class="form-control" placeholder="" required="required" autocomplete="off" />
