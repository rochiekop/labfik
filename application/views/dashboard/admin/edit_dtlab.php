          ...
          <div class="card-body">
            <div class="custom-form">
              <div class="form-group">
                <input type="text" name="title" value="<?= $dt_lab['title'] ?>" class="form-control" placeholder="" required="required" autocomplete="off" />
                <label>Judul</label>
                <small class="form-text text-danger"><?= form_error('title') ?>.</small>
              </div>
              <div class="form-group" style="margin-bottom:5px;">
                <textarea name="body" class="form-control" placeholder="" required="required" autocomplete="off"><?= $dt_lab['body'] ?></textarea>
            ...
            <input type="hidden" value="<?= $dt_lab['images'] ?>" class="form-control" name="image!updated">
          </div>
