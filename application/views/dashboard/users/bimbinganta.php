  ...
  <main class="akun-container">
    ...
    <ul class="nav nav-pills" id="myTab" role="tablist">
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo ($step->status_preview == 'sidang') ? 'btn-secondary active' : ''; ?>" id="pat-tab" data-toggle="tab" href="#pat" role="tab" aria-selected="<?php echo ($step->status_preview == 'preview1') ? 'true' : 'false'; ?>">Sidang Akhir</a>
      </li>
    </ul>
