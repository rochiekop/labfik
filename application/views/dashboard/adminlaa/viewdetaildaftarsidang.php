                ...
                <tr>
                  ...
                  <?php if ($f['status_adminlaa'] == "Dikirim" or $f['status_adminlaa'] == "Update") : ?>
                    <?php if ($f['view_adminlaa'] == "Belum Dilihat") :  ?>
                      <td></td>
                    <?php else : ?>
                      <td> <a href="<?= base_url('adminlaa/accfilependaftaransidang/') . encrypt_url($f['id']); ?>" class="btn badge badge-success">Acc</a>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <?php if ($m['view_adminlaa'] == "Belum Dilihat") : ?>
                <a href="<?= base_url('adminlaa/displayactionadminlaads/') . $m['id'] ?>" class="close" aria-label="Close"> <span aria-hidden="true">&times;</span></a>
      ...
      <?php foreach ($file as $f) : ?>
        <div class="modal fade" id="komen<?= encrypt_url($f['id']); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <form action="<?= base_url('adminlaa/berikomentardaftarsidang/') . encrypt_url($f['id']); ?>" method="post">
                <div class="modal-header">
                ...
                <div class="modal-body">
                  <textarea name="komentar" id="komentar" cols="46" rows="5"><?= $f['komentar'] ?></textarea>
                </div>
        ...
        <div class="modal fade bd-example-modal-sm" id="tolak<?= $f['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-sm">
            <div class="modal-content">
              ...
              <form action="<?= base_url('adminlaa/tolakfilependaftaransidang') ?>" method="post" enctype="multipart/form-data">
