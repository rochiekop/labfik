...
<main class="akun-container">
    ...
    <div class="input-group">
        ...
        <a class="btn btn-primary" href="<?= base_url('karya/tambah') ?>" style="margin-left: 20px;"><span class="fas fa-fw fa-plus"></span> karya </a>
    </div>
                    ...
                    <?php else : ?>
                        ...
                        foreach ($tampilan as $data) { ?>
                            <tr>
                                ...
                                <td><?= $data->status ?></td>
                                <td>
                                    <a href="<?= base_url('karya/delete/' . $data->id_tampilan); ?>" onclick="return confirm('yakin ingin menghapus data ini?')"><span class="fas fa-trash"></span></a>
                                </td>
                            </tr>
                        <?php $no++;
                        } ?>
