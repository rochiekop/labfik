                ...
                <form method="post" id="form-upload" enctype="multipart/form-data" action="<?= base_url('karya/edit/' . $tampilan->id_tampilan); ?>">
                    <div class="card-body">
                        <div class="custom-form">
                            ...
                            <div class="form-group">
                                <input type="text" name="No_wa" value="<?= $tampilan->No_wa ?>" class="form-control" placeholder="No_Wa" required="required" autocomplete="off" />
                                <label>No.WA Aktif</label>
                            </div>
                            <div class="form-group">
                                <input type="text" name="No_hp" value="<?= $tampilan->No_hp ?>" class="form-control" placeholder="No_Hp" required="required" autocomplete="off" />
                                <label>No.Hp</label>
                            </div>
                            <div class="form-group">
