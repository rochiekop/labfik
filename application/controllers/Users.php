...
class Users extends CI_Controller
{
  ...
  public function progressbimbingan($id)
  {
    ...
    $data['nama_pembimbing1'] = $this->db->get_where('user', array('id' => $data['lecturers']->dosen_pembimbing1))->row();
    $data['nama_pembimbing2'] = $this->db->get_where('user', array('id' => $data['lecturers']->dosen_pembimbing2))->row();
