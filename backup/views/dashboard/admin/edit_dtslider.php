...
<main class="akun-container">
  ...
  <div class="row">
    ...
    <div class="col-md-4" id="imagePreview">
      <?php if ($dt_slider['images'] != "default.jpg") : ?>
        <img src="<?= base_url('assets/img/slider/') . $dt_slider['images'] ?>" alt="<?= $dt_slider['title'] ?>" class="placeholder-img">
      <?php else : ?>
        <img src="<?= base_url('assets/img/slider/default.jpg'); ?>" alt="<?= $dt_slider['title'] ?>" class="placeholder-img">
      <?php endif; ?>
          ...
          <div class="card-body">
            <div class="custom-form">
              <div class="form-group">
                <input type="text" name="title" value="<?= $dt_slider['title'] ?>" class="form-control" placeholder="" required="required" autocomplete="off" />
                <label>Judul</label>
              ...
              <input type="hidden" value="<?= $dt_slider['images'] ?>" class="form-control" name="image!updated">
            </div>
