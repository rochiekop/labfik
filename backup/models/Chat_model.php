...
class Chat_model extends CI_Model 
{
	...
	public function UpdateStatusRead($receiver_id, $sender_id)
	{
		$data = array(
			'status' => 'read'
		);
		$this->db->update('chat',$data,array('receiver_id' => $receiver_id, 'sender_id' => $sender_id));
	...
	public function CountUnreads($receiver_id, $sender_id)
	{
		$this->db->select('id');
		$this->db->from('chat');
